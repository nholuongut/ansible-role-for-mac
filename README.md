...
## Requirements
  ...
  - **Homebrew**: Requires `homebrew` already installed (you can use `nholuong.homebrew` to install it on your Mac).
...
## Dependencies
  ...
  - (Soft dependency) `nholuong.homebrew`
...
See the [Mac Development Ansible Playbook](https://github.com/nholuong/mac-dev-playbook) for an example of this role's usage.
